...
This document is a quick guide to implementing account credits powered by Lightrail. The focus will be on providing a quick step-by-step guide to implementing this use-case by directly calling the Lightrail API. 
